...
@pytest.mark.parametrize('new_york_orderbook,chicago_orderbook,estimate_of_asset_price,orders_count,\
...
chicago_orderbook, estimate_of_asset_price, orders_count, ticks_between_orders, spread_around_asset, new_york_bid,
